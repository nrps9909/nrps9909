...
| Public upstream PRs reviewed as an external contributor |       **163** |
...
- [Marked #4086](https://github.com/markedjs/marked/pull/4086): preserve literal tabs inside list code spans and fences. Addressed maintainer feedback with 16 exact-output spec fixtures, all failing on base and passing with the fix. Full validation passes 1,818 spec-harness tests, 191 unit tests, build and lint. The signed/Verified PR is open; upstream tests and Vercel preview require maintainer authorization.
