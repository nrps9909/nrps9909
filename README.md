...
I [revalidated and approved Ant Design's localized clear-button accessibility update on its latest head](https://github.com/ant-design/ant-design/pull/58267#pullrequestreview-4961865812) after the Select, Cascader, and TreeSelect suites passed with the declared rc-select dependency and all review threads were resolved. I also [approved Cascader's explicit `null` empty-state handling](https://github.com/ant-design/ant-design/pull/59028#pullrequestreview-4961842901) after the full Cascader suite and five independent probes verified `null`, `false`, empty-string, zero, and inherited-default behavior.
